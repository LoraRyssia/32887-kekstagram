...
(function() {
  ...
  Resizer.prototype = {
    ...
    redraw: function() {
      ...
      //Создание надписи с размерами
      this._ctx.font = '16px Arial';
      this._ctx.fillStyle = 'white';
      this._ctx.textAlign = 'center';
      this._ctx.textBaseline = 'bottom';
      this._ctx.fillText(this._image.naturalWidth + ' x ' + this._image.naturalHeight, 0, (-this._resizeConstraint.side / 2) - this._ctx.lineWidth / 2 - 10);
